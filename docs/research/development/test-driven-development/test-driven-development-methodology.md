...
date: 2026-03-18
summary: Surveys TDD across eight methodological variants—classic TDD, ATDD, BDD, Double-Loop TDD, and related practices—synthesizing two decades of empirical research showing small-to-medium positive effects on external quality (40–90% defect reduction in best-documented industrial studies) while revealing conflicting evidence on productivity. Examines each variant's theoretical mechanism, evidence base, implementations, and known limitations.
keywords: [development, test-driven-development, tdd, bdd, software-quality]
---
