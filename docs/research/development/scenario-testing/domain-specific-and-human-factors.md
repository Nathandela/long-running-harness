---
title: "Scenario Testing for CS Development: Domain-Specific Applications & Human Factors"
date: 2026-03-07
summary: Argues that the same foundational scenario primitives are preserved across five high-stakes domains—safety-critical/embedded, distributed systems/microservices, security/adversarial, real-time/performance, and human-centered design—but that surrounding constraints of regulation, failure consequence, adversarial intent, and cognitive process transform generation and evaluation so fundamentally that domain-naive approaches fail systematically. Each domain imposes a distinct epistemological contract on what "tested enough" means.
keywords: [development, scenario-testing, safety-critical, security-testing, human-factors]
---
