---
title: Logic and Proof Theory under the Curry-Howard Correspondence
date: 2026-02-25
summary: Documents the Curry-Howard correspondence—identifying proofs with programs and propositions with types—across intuitionistic propositional logic, Martin-Löf dependent type theory, homotopy type theory, linear logic/session types, and classical logic via CPS/lambda-mu calculus. Emphasizes mechanisms showing how each system realizes propositions-as-types and how computation arises as proof normalization.
keywords: [development, curry-howard, type-theory, proof-theory, dependent-types]
---
