---
title: "Linter Custom Rule APIs: Cross-Ecosystem Research"
date: 2026-03-11
summary: "Surveys config-only and custom rule APIs across ESLint, Ruff, golangci-lint, Clippy, and language-agnostic tools like Semgrep and ast-grep, assessing each linter's surface for automated lint rule proposal."
keywords: [development, linter-apis, static-analysis, eslint, code-quality]
---
