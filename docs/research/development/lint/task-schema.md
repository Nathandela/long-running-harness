---
title: "Beads Task Schema for Lint Rule Proposals"
date: 2026-03-11
summary: "Designs the beads task structure for proposed lint rules, mapping two rule classes (config-only and AST-based) to description, design, and acceptance criteria fields for automated rule implementation."
keywords: [development, task-schema, lint-rules, automation, specification]
---
