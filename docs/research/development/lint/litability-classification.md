---
title: "LLM-Driven Lintability Classification"
date: 2026-03-11
summary: "Defines a taxonomy for classifying whether coding lessons can be mechanically enforced by a linter, proposing an LLM classifier with reasoning-first structured output and few-shot boundary examples."
keywords: [development, lintability, llm-classification, static-analysis, code-quality]
---
